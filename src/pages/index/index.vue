					...
					>
						...
						<view class="card-body">
							...
							<view class="reactions">
								<view
									class="reaction"
									:class="{ 'r-on': item.myReaction === r.key }"
									v-for="r in reactions"
									:key="r.key"
									@tap.stop="item.myReaction = r.key"
								>
									<uni-icons
										:type="r.icon"
										size="13"
										:color="item.myReaction === r.key ? r.activeColor : '#9CA3AF'"
									/>
...
<style lang="scss" scoped>
	...
	.header {
		...
		.ht-tab {
			...
			.ht-text { font-size: 28rpx; color: #9CA3AF; font-weight: 500; }

			&.active {
				.ht-text { color: #1A1A2E; font-weight: 700; }
	...
	.ch {
		...
		.ch-av {
			...
			.ch-av-t { font-size: 26rpx; color: #fff; font-weight: 800; }
		}

		.ch-meta {
			flex: 1;

			.ch-name { display: block; font-size: 30rpx; font-weight: 700; color: #1A1A2E; margin-bottom: 6rpx; }
			...
			.ch-sub {
				...
				.ch-model {
					...
					.ch-model-txt { font-size: 20rpx; color: #2F8A57; font-weight: 500; }
				}

				.ch-time { font-size: 20rpx; color: #9CA3AF; }
			}
		}
	}
	...
	.bill {
		...
		.bill-left {
			...
			.bill-spent-label { font-size: 20rpx; color: #9CA3AF; }
			.bill-cost {
				font-size: 48rpx;
				font-weight: 900;
				color: #E45C1A;
		...
		.bill-right {
			...
			.bill-token-unit { font-size: 20rpx; color: #9CA3AF; }
		}
	}
	...
	.reactions {
		...
		.reaction {
			...
			.r-text { font-size: 20rpx; color: #9CA3AF; font-weight: 500; }
	...
	.card-actions {
		...
		.ca {
			...
			.ca-val { font-size: 24rpx; color: #9CA3AF; }
		}
		...
		.ca-meoo {
			...
			.ca-meoo-text { font-size: 22rpx; color: #6B7280; font-weight: 600; }
			.ca-meoo-val  { font-size: 22rpx; color: #9CA3AF; }
		}
	}
	...
	.skill-card {
		...
		.sc-head {
			...
			.sc-badge {
				...
				.sc-badge-text { font-size: 18rpx; color: #5B5BD6; font-weight: 800; letter-spacing: 0.5rpx; }
			}

			.sc-scene { font-size: 20rpx; color: #9CA3AF; }
		}
		...
		.sc-metrics {
			...
			.sc-m {
				...
				.sc-mval { font-size: 26rpx; font-weight: 800; color: #1A1A2E; }
				.sc-mval.orange { color: #FF7A45; }
				.sc-mval.green  { color: #2F8A57; }
				.sc-mlabel { font-size: 18rpx; color: #9CA3AF; }
			}

			.sc-mdiv { width: 1rpx; height: 32rpx; background: rgba(0,0,0,0.08); }
		}
		...
		.sc-foot {
			...
			.sc-author {
				...
				.sc-author-name { font-size: 22rpx; color: #6B7280; }
			}
			...
			.sc-copy {
				...
				.sc-copy-text { font-size: 22rpx; color: #fff; font-weight: 700; }
			}
		}
	}
